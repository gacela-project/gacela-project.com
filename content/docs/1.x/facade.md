...
Other modules, controllers, and commands never reach into your module's internals. They call the Facade, which delegates to the [Factory](/docs/1.x/factory) to build the right objects and run the logic. This keeps your module's domain encapsulated and easy to refactor.
:::
...
`#[ServiceMap]` is repeatable. Declare as many resolvable services as the class needs. Full reference: [Service Map](/docs/1.x/service-map).
