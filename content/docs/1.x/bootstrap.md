...
(A similar behaviour already exists for your app config files. See: [Config files for diff env](/docs/1.x/config#config-files-for-different-environments).)
...
- [Bindings](/docs/1.x/bindings): addBinding, factory services, protected services, aliases, contextual bindings
- [Extensions & Plugins](/docs/1.x/extensions): plugins, extendService, extendGacelaConfig, handler registry
