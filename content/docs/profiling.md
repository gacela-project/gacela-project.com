---
title: Profiling
description: Instrument code with the in-memory Profiler and read the results with profile:report, getEntries(), or getStats().
---
...
- [`profile:report`](/docs/cli#profile-report): output formats and sorting
- [Events](/docs/events): lifecycle events, the other observability surface, better suited to tracing resolution
